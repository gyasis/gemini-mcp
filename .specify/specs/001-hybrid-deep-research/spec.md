...
|------|---------|------------|
| `start_deep_research` | Wrap Gemini Deep Research with hybrid sync→async switching | HIGH |
| `check_research_status` | Poll status of running research | ZERO |
| `get_research_results` | Retrieve completed results | ZERO |
| `cancel_research` | Cancel running research | ZERO |
| `estimate_research_cost` | Estimate before starting | LOW |
| `save_research_to_markdown` | Save results to permanent MD files | ZERO |
